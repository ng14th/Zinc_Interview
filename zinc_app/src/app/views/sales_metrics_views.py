...
from src.app.controllers.sales_controllers import get_revenue_by_date, get_revenue_daily
from src.app.serializers.sales_serializer import SalesSerializer


class SalesMetricsViewSet(viewsets.ModelViewSet):
    queryset = Sales.objects.all()
    serializer_class = SalesSerializer
    permission_classes = (permissions.AllowAny,)

    @action(detail=False, methods=["GET"], url_path="revenue")
    def revenue_sale(self, request, *args, **kwargs):
    ...
    def revenue_daily(self, request, *args, **kwargs):
        ...
        data = get_revenue_daily(start, end)
